...
def render_estudiante_asignar(nombre: str) -> rx.Component:
    return rx.hstack(
        rx.text(nombre, size="2", color=color_texto_principal, weight="medium"), 
        rx.spacer(),
        rx.button(
        ...
        width="100%", padding="0.75em", border_bottom=f"1px solid {color_borde}", align="center"
    )

def render_pregunta(pregunta: PreguntaUI, index: int) -> rx.Component:
    estilo_label = {"weight": "medium", "size": "2", "color": color_texto_secundario}
    estilo_input = {"width": "100%", "background_color": "white", "border": f"1px solid {color_borde_input}", "color": color_texto_principal}
    ...
    return rx.card(
        rx.vstack(
            rx.hstack(
                ...
                rx.cond(
                    ...
                    rx.icon("trash", color=color_error_oscuro, cursor="pointer", on_click=lambda: TareaState.eliminar_pregunta(index)),
                ),
                width="100%",
            ),
            ...
            rx.hstack(
                rx.vstack(
                    rx.text("Tipo de respuesta", weight="bold", size="2", color=color_texto_principal),
                    rx.select(
                ...
                rx.vstack(
                    rx.text("Calificación Máxima", weight="bold", size="2", color=color_texto_principal),
                    rx.input(
            ...
            rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.text("Opciones del Test", weight="bold", size="2", color=color_texto_principal),
                    rx.grid(
                    ...
                    rx.text("Opción correcta (Texto o número de la opción)", weight="bold", size="2", color=color_texto_principal, margin_top="1em"),
                    rx.input(
        ...
        width="100%", padding="1.5em", border=f"1px solid {color_borde}", background_color=color_fondo_pagina, margin_top="1em"
    )
    ...
    return rx.flex(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.card(
                    rx.vstack(
                        rx.heading("1. Tipo de Actividad", size="4", color=color_texto_principal, weight="bold"),
                        rx.radio(
                            ["Ejercicio", "Prueba"],
                            direction="row",
                            on_change=TareaState.set_tipo_tarea,
                            value=TareaState.tipo_tarea,
                            spacing="4", color_scheme="indigo", size="2", color=color_texto_secundario, weight="medium",
                        ),
                        
                        rx.divider(margin_y="1.5em", background_color=color_borde),
                        
                        rx.heading("2. Información General", size="4", color=color_texto_principal, weight="bold"),
                        rx.vstack(
                            ...
                            rx.hstack(
                                rx.vstack(
                                    ...
                                    rx.box(
                                        ...
                                        rx.icon("calendar-days", position="absolute", right="0.75em", top="50%", transform="translateY(-50%)", color=color_texto_gris, _hover={"color": color_texto_principal}, on_click=rx.call_script("document.getElementById('input_fecha_inicio').showPicker()"), cursor="pointer"),
                                ...
                                rx.vstack(
                                    ...
                                    rx.box(
                                        ...
                                        rx.icon("calendar-days", position="absolute", right="0.75em", top="50%", transform="translateY(-50%)", color=color_texto_gris, _hover={"color": color_texto_principal}, on_click=rx.call_script("document.getElementById('input_fecha_fin').showPicker()"), cursor="pointer"),
                                        position="relative", width="100%"
                                    ),
                                    width="100%", spacing="1"
                                ),
                        ...
                        rx.heading("3. Configuraciones Específicas", size="4", color=color_texto_principal, weight="bold"),
                        rx.cond(
                            ...
                            rx.hstack(
                                ...
                                rx.vstack(
                                    ...
                                    rx.hstack(
                                        ...
                                        rx.text("Permitir reintentos", color=color_texto_principal, weight="medium", size="2"),
                            ...
                            rx.vstack(
                                ...
                                rx.box(
                                    rx.text(TareaState.tiempo_limite_calculado, weight="bold", color=rx.cond(TareaState.tiempo_limite_calculado.contains("Error"), color_error_oscuro, color_texto_principal)),
                                    padding="0.5em 1em",
                                    background_color=rx.cond(TareaState.tiempo_limite_calculado.contains("Error"), color_error_fondo, color_fondo_claro),
                                    border_radius="6px",
                                    border=rx.cond(TareaState.tiempo_limite_calculado.contains("Error"), "1px solid #fca5a5", f"1px solid {color_borde_input}"),
                        ...
                        rx.heading("4. Preguntas", size="4", color=color_texto_principal, weight="bold"),
                        rx.vstack(
                        ...
                        rx.heading("5. Asignación", size="4", color=color_texto_principal, weight="bold"),
                        rx.radio(
                            ["Grupo", "Estudiantes"],
                            direction="row",
                        ...
                        rx.cond(
                            ...
                            rx.vstack(
                                rx.input(
                                    rx.input.slot(rx.icon("search", size=16, color=color_texto_claro)),
                                ...
                                rx.box(
                                    ...
                                    max_height="200px", overflow="auto", border=f"1px solid {color_borde}", border_radius="6px", background_color="white", width="100%"
                                ),
                    ...
                    width="100%", padding="2.5em", box_shadow="lg", background_color="white", border=f"1px solid {color_borde}", border_radius="12px"
                ),
